...
const Cards = ({info}) => {
  return (
    <div className='flex justify-center items-center mx-3 border border-green-400 h-[100%] md:h-[] w-[100%] md:w-[22%] relative group overflow-hidden hover:shadow-xl hover:shadow-black/30 transition-shadow rounded-md'>
